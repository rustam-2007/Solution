    ...
    <div class="ml-4">
      <div class="ml-11 mt-8">
        ...
        <p class="text-base">- Работа над сложными и интересными веб-интерфейсами;<br>
          ...
          - Разработка и улучшение сценариев поведения пользователей;<br>
      ...
      <div class="ml-11 mt-8">
        ...
        <p class="text-base">- Опыт создания мобильных и веб интерфейсов;<br>
          ...
          - Свободное владение программами Adobe Photoshop и Adobe Illustrator;<br>
          - Умение работать с композицией, типографикой и цветом;<br>
          - Знание современных трендов дизайна и следование им;<br>
          - Умение аргументировать свои решения;<br>
          - Перфекционизм и внимание к деталям;<br>
          - Знакомство с iOS Guidelines, Material Design Guidelines;<br>
